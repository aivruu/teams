...
public record ConfigurationContainer<C>(
   @NotNull C model,
   @NotNull HoconConfigurationLoader loader,
   @NotNull Class<C> modelClass) {
  private static final ComponentLogger LOGGER =
     TeamsPlugin.getPlugin(TeamsPlugin.class).getComponentLogger();
  ...
  public @NotNull CompletableFuture<@Nullable ConfigurationContainer<C>> reload() {
    return CompletableFuture.supplyAsync(() -> {
      try {
        ...
        return (updatedModel == null) ? null : new ConfigurationContainer<>(updatedModel,
           this.loader, this.modelClass);
